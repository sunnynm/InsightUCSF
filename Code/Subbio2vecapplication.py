...
with open('./CardKeywordDistSub.csv', mode='w', encoding='UTF-8', newline='') as file:
	ewrite = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
	ewrite.writerow(['Document', 'Phrase', 'CardVal', 'RefinedWord', 'RefinedVal', "ManRefWord", "ManRefVal"])
